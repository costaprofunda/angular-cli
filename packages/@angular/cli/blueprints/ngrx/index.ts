...
export default Blueprint.extend({
  ...
  locals: function (options: any) {
    options.flat = options.flat !== undefined ?
      options.flat : CliConfig.getValue('defaults.action.flat');
  ...
  afterInstall(options: any) {
    ...
    //     Action is generated but not provided,
    ...
    //   const className = stringUtils.classify(`${options.entity.name}Actions`);
    //   const fileName = stringUtils.dasherize(`${options.entity.name}.actions`);
